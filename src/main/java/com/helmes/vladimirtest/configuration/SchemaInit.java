package com.helmes.vladimirtest.configuration;
...
public class SchemaInit {
    ...
    public static class SchemaInitBean implements InitializingBean {
        ...
        @Autowired
        public SchemaInitBean(DataSource dataSource, @Value("${spring.jpa.properties.hibernate.default_schema}") String schemaName) {
